...
export default function MiddleManagerRefundsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">환불건 관리 (중간관리자)</h1>
          <p className="text-muted-foreground">제출된 환불 청구를 확인하고 처리합니다. (장한평 제외)</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>장한평 성능장을 제외한 모든 환불 청구 내역을 관리할 수 있습니다.</CardDescription>
        </CardHeader>
        <CardContent>
          <RefundManagementTable apiEndpoint="/api/middle-manager/refunds" />
        </CardContent>
      </Card>
    </div>
  )
